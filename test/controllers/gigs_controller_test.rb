...
class GigsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gig" do
    assert_difference('Gig.count') do
      post gigs_url, params: { gig: { description: @gig.description, name: @gig.name } }, as: :json
    end
  ...
  test "should update gig" do
    patch gig_url(@gig), params: { gig: { description: @gig.description, name: @gig.name } }, as: :json
    assert_response 200
  end
